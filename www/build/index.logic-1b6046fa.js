...
let TlkProgress = class {
  ...
  render() {
    return (h(Host, { class: "tlk-progress" }, h("div", { role: "progressbar", class: "tlk-progress__bar", "data-indeterminate": this.indeterminate, "aria-valuenow": this.value, "aria-valuemin": this.min, "aria-valuemax": this.max })));
  }
