...
let TlkProgress = class {
  ...
  render() {
    return (h(Host, null, h("div", { role: "progressbar", class: "tlk-progress", tabIndex: 0, "data-indeterminate": this.indeterminate, "aria-valuenow": this.value, "aria-valuemin": this.min, "aria-valuemax": this.max }, h("div", { class: "tlk-progress__bar" }))));
  }
