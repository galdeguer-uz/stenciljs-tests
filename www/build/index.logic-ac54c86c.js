...
const indexStylesCss = ":host{background-color:#f3f3f3;border-radius:9999px;display:inline-flex;height:16px;overflow:hidden;position:relative;width:100%}:host .tlk-progress__bar{background-color:blue;height:100%}:host [data-indeterminate]{animation:1.5s ease 0s infinite normal none running indeterminateAnimation;background:linear-gradient(to right, transparent 0%, blue 50%, transparent 100%);position:absolute;width:50%;will-change:left}@keyframes indeterminateAnimation{0%{left:-50%}100%{left:100%}}";
...
let TlkProgress = class {
  ...
  render() {
    return (h(Host, { class: "tlk-progress", role: "progressbar", "data-indeterminate": this.indeterminate, "aria-valuenow": this.value, "aria-valuemin": this.min, "aria-valuemax": this.max }, h("div", { class: "tlk-progress__bar" })));
  }
