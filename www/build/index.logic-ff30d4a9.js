...
let TlkProgress = class {
  ...
  render() {
    return (h(Host, null, this.theme && (h("style", null, this.theme)), h("div", Object.assign({ role: "progressbar", class: "tlk-progress", tabIndex: 0, "data-indeterminate": this.indeterminate }, this.getAriaAttributes()), h("div", { class: "tlk-progress__bar" }))));
  }
